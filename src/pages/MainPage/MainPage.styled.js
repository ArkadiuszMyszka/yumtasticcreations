...
@media (min-width: 1200px) {
    ...
    background-image: url(${spinachBottomIMG}), url(${spinachCenterIMG}), url(${spinachTopIMG}), url(${triangleDesktop});
}
@media (min-width: 768px) and (max-width: 1199px) {
    background-position: 0% 89%, 280% 0%, 0% 1%, 100% 0%;
    background-size: 520px, 700px, 75px, 330px;
    background-image: url(${spinachBottomIMG}), url(${spinachCenterIMG}), url(${spinachTopIMG}), url(${triangleTablet});
}
background-image: url(${spinachBottomIMG}), url(${spinachCenterIMG}), url(${spinachTopIMG}), url(${triangleMobile});
